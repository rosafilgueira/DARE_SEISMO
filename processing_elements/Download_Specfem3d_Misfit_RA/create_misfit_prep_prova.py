...
os.system('wget -P {} https://gitlab.com/project-dare/WP6_EPOS/raw/RA_total_script/processing_elements/Download_Specfem3d_Misfit_RA/preprocessing_functions.py'.format(path))
...
#can we use the input files already uploaded in /home/mpiuser/sfs/fmagnoni/uploads/wp6-input/wp6_inputfiles ? I think comment this lines since I defined below MISFIT_PREP_CONFIG PREP_IN_DATA
# os.system('wget -P {} https://gitlab.com/project-dare/dare-api/tree/master/examples/wp6/wp6_inputfiles/processing.json'.format(path))
# os.system('wget -P {} https://gitlab.com/project-dare/dare-api/tree/master/examples/wp6/wp6_inputfiles/events_info.xml'.format(path))
#
...
from dispel4py.workflow_graph import write_image  #fm
