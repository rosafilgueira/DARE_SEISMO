...
class NormPE(GenericPE):
    ...
    def _process(self, data):
        ...
        self.write('output_mean', [stream, filename, data_mean, 'mean'],metadata={"output_mean":data_mean})
        self.write('output_max', [stream, filename, data_max, 'max'],metadata={"output_max":data_max})
