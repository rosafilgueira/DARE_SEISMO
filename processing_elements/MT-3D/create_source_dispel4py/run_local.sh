...
#dispel4py simple dispel4py_CMTSOLUTION_total.py   -d '{"create_source":[{"file_url": "'$file_url'", "out_url": "'$out_url$type'/", "pertubation": 'null', "UTM": "False", "type": "'$type'", "index": '$Npar'}]}'
